      ...
      <section>
        ...
        >
          <div className="container">
            <div className="row">
              <div className="col-md-6" style={{ paddingTop: 300 }}>
                <h1
                  data-aos="fade-right"
              ...
              <div
                className="col-md-6"
                style={{ paddingTop: 300, paddingLeft: 300 }}
              >
                <img
                  data-aos="fade-left"
                  data-aos-duration={1000}
            ...
            <div className="row">
              <div className="col-md-12 col-lg-5">
                <a
                  ...
                  data-aos-once="true"
                  href="/Catalogue"
                  style={{ fontSize: 30, marginTop: "-370px", paddingLeft: 7 }}
                >
          ...
          >
            <div className="col" style={{ paddingTop: 0, paddingBottom: 0 }}>
              ...
              >
                ...
                <p style={{ color: "var(--bs-body-bg)" }}>
                  <strong>
                    This principle emphasizes the importance of protecting
                    personal and sensitive data processed by AI systems,
            ...
            <div className="col">
              ...
              >
                ...
                <p style={{ color: "var(--bs-body-bg)", fontWeight: "bold" }}>
                  Security in trustworthy AI focuses on safeguarding AI systems
                  from unauthorized access and attacks, ensuring the integrity
                  and reliability of their operations and data
                  <br />
                  <br />
                </p>
              </div>
              ...
              >
                ...
                <p style={{ color: "var(--bs-body-bg)" }}>
                  <strong>
                    ...
                    understandable and interpretable reasoning for their
                    decisions and actions, making them transparent and
                ...
                <p>
                  <strong>
                    <span style={{ color: "rgb(255, 255, 255)" }}>
                      Fairness refers to the principle of ensuring AI systems do
                      not create or perpetuate bias, treating all individuals
