...
function Homepage() {
  ...
  <section>
          ...
          >
            ...
            <p style={{ color: "var(--bs-body-bg)" }}>
              <strong>
                ...
                understandable and interpretable reasoning for their decisions
                and actions, making them transparent and accountable to users
              </strong>
            </p>
          </div>
        </div>
    ...
    <footer>
      <div className="container py-4 py-lg-5" style={{ marginTop: "-95px" }}>
